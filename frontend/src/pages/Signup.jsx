        ...
        <div className='flex justify-center items-center min-h-screen bg-gray-200 p-5'>
            <Card className="w-full max-w-sm border border-gray-300">
                ...
                <CardFooter className="flex-col gap-2">
                    <Button onClick={submitHandler} type="submit" className="w-full cursor-pointer bg-black hover:bg-white hover:text-black">
                        {loading ? <><Loader2 className='h-4 w-4 animate-spin mr-2' />Please wait</> : 'Signup'}
                    </Button>
                    <p className="text-gray-700 text-sm">Already have an account? <Link to={'/'} className='hover:underline cursor-pointer text-gray-500 hover:text-black'>Login</Link></p>
                </CardFooter>
            </Card>
        </div>
    )
